...
import ManualPaymentTable from "./ManualPaymentsTable";

export default function ManualPaymentTablePage() {
  return (
    <div className="max-w-7xl mx-auto p-6">
      <div className="bg-white rounded-lg shadow-sm border p-6">
        <h1 className="text-2xl font-bold mb-6">Manual Payment</h1>
